...
/**
 * The interface of extensions providing new prediction function analysis strategies.
 * 
...
public interface IPredictionFunctionStrategyExtension extends ISoPeCoExtension<IPredictionFunctionStrategy> {
	...
	/**
	 * Creates a prediction function analysis strategy provided by the extension.
	 */
