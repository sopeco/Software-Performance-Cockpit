...
/**
 * This is the item provider adapter for a {@link org.sopeco.model.configuration.measurements.MeasurementSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasurementSpecificationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MeasurementSpecification_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MeasurementSpecification_name_feature", "_UI_MeasurementSpecification_type"),
				 MeasurementsPackage.Literals.MEASUREMENT_SPECIFICATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MeasurementsPackage.Literals.MEASUREMENT_SPECIFICATION__EXPERIMENT_SERIES_DEFINITIONS);
			childrenFeatures.add(MeasurementsPackage.Literals.MEASUREMENT_SPECIFICATION__INITIALIZATION_ASSIGNEMTS);
		}
	...
	public String getText(Object object) {
		String label = ((MeasurementSpecification)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MeasurementsPackage.Literals.MEASUREMENT_SPECIFICATION__EXPERIMENT_SERIES_DEFINITIONS,
				 MeasurementsFactory.eINSTANCE.createExperimentSeriesDefinition()));

		newChildDescriptors.add
			(createChildParameter
				(MeasurementsPackage.Literals.MEASUREMENT_SPECIFICATION__INITIALIZATION_ASSIGNEMTS,
