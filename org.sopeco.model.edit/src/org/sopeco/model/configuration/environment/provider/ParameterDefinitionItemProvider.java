...
/**
 * This is the item provider adapter for a {@link org.sopeco.model.configuration.environment.ParameterDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnvironmentPackage.Literals.PARAMETER_DEFINITION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnvironmentPackage.Literals.PARAMETER_DEFINITION__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterDefinition_role_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterDefinition_role_feature", "_UI_ParameterDefinition_type"),
				 EnvironmentPackage.Literals.PARAMETER_DEFINITION__ROLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFullNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterDefinition_fullName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterDefinition_fullName_feature", "_UI_ParameterDefinition_type"),
				 EnvironmentPackage.Literals.PARAMETER_DEFINITION__FULL_NAME,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
