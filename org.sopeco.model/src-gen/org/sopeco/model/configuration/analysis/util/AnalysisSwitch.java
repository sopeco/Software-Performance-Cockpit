 ...
 * $Id$
 */
package org.sopeco.model.configuration.analysis.util;
...
import org.sopeco.model.configuration.analysis.*;
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnalysisPackage.ANALYSIS_CONFIGURATION: {
				...
				if (result == null) result = caseSerializable(analysisConfiguration);
