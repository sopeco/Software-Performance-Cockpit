...
public interface MeasurementsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EXPERIMENT_SERIES_DEFINITION__EXPLORATION_STRATEGY = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EXPERIMENT_SERIES_DEFINITION__EXPERIMENT_ASSIGNMENTS = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EXPERIMENT_SERIES_DEFINITION__EXPERIMENT_TERMINATION_CONDITION = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int EXPERIMENT_SERIES_DEFINITION__PREPERATION_ASSIGNMENTS = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int EXPERIMENT_SERIES_DEFINITION__NAME = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int EXPERIMENT_SERIES_DEFINITION_FEATURE_COUNT = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int PARAMETER_VALUE_ASSIGNMENT__PARAMETER = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PARAMETER_VALUE_ASSIGNMENT_FEATURE_COUNT = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EXTENSIBLE_ELEMENT__CONFIGURATION = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EXTENSIBLE_ELEMENT__NAME = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EXTENSIBLE_ELEMENT_FEATURE_COUNT = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int EXPERIMENT_TERMINATION_CONDITION_FEATURE_COUNT = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_NODE__KEY = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_NODE__VALUE = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_NODE_FEATURE_COUNT = CommonPackage.SERIALIZABLE_FEATURE_COUNT + 2;
	 ...
	 *        valueDataType="org.eclipse.emf.ecore.EString" superTypes="org.sopeco.model.configuration.common.Serializable"
	 * @generated
	 */
