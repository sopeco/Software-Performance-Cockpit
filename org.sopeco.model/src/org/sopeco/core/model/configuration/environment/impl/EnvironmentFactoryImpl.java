...
public class EnvironmentFactoryImpl extends EFactoryImpl implements EnvironmentFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case EnvironmentPackage.MEASUREMENT_ENVIRONMENT_DEFINITION: return createMeasurementEnvironmentDefinition();
			case EnvironmentPackage.PARAMETER_NAMESPACE: return createParameterNamespace();
			case EnvironmentPackage.PARAMETER_DEFINITION: return createParameterDefinition();
			default:
