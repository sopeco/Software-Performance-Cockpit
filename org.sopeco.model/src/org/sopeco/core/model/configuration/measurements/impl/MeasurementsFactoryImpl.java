...
public class MeasurementsFactoryImpl extends EFactoryImpl implements MeasurementsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MeasurementsPackage.MEASUREMENT_SPECIFICATION: return createMeasurementSpecification();
			case MeasurementsPackage.EXPERIMENT_SERIES_DEFINITION: return createExperimentSeriesDefinition();
			case MeasurementsPackage.EXPLORATION_STRATEGY: return createExplorationStrategy();
			case MeasurementsPackage.CONFIGURATION_NODE: return (EObject)createConfigurationNode();
			case MeasurementsPackage.NUMBER_OF_REPETITIONS: return createNumberOfRepetitions();
			case MeasurementsPackage.TIME_OUT: return createTimeOut();
			case MeasurementsPackage.CONSTANT_VALUE_ASSIGNMENT: return createConstantValueAssignment();
			case MeasurementsPackage.DYNAMIC_VALUE_ASSIGNMENT: return createDynamicValueAssignment();
			default:
